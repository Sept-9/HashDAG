...
public:
	...
	// LOD: store path together with the hit level in the 4th uint of the surface.
	...
	{
#ifdef __CUDA_ARCH__
		surf2Dwrite(make_uint4(path.x, path.y, path.z, hitLevel & 0xFFu), surface, x * sizeof(uint4), y);
#endif
	}
